    ...
    <div class="flex justify-between">
      <div>
        <div class="p-1 mt-3 mr-3 ml-3 mb-3">
          <img class="rounded-lg" style="width: 290px; height: 275px;" src="image/profilee.jpeg" alt="User Avatar">
        </div>
      </div>
...
<div class="container mt-6 ml-0 mx-auto" style="width: 50%;">
  <div class="bg-[#80AF81] rounded-lg shadow-md p-6" style="width: calc(100% - 60px); margin: 1;">
    <h1 class="text-2xl font-bold text-white mb-4">LAYANAN AKADEMIK</h1>
    <div class="flex justify-between">
      <!-- Kolom Kiri -->
      <div class="flex-1 mr-2">
        <div class="bg-[#508D4E] p-1 mt-4 rounded-lg">
          <h1 class="text-lg font-bold text-center mx-auto mt-1.5 text-white">LIST RUANG KULIAH</h1>
        </div>
        <div class="bg-[#508D4E] p-1 mt-4 rounded-lg">
          <h1 class="text-lg text-center font-bold mx-auto mt-1.5 text-white">LIST RUANG KULIAH</h1>
        </div>
        <div class="bg-[#508D4E] p-1 mt-4 rounded-lg">
          <h1 class="text-lg text-center font-bold mx-auto mt-1.5 text-white">LIST RUANG KULIAH</h1>
        </div>
